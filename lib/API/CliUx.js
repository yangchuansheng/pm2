...
UX.dispAsTable = function (list, interact_infos) {
  ...
  list.forEach(function (l) {
    ...
    if (l.pm2_env.pmx_module == true) {
      ...
      if (!stacked) { obj[key].push(l.pm2_env.restart_time ? l.pm2_env.restart_time : 0); }
      ...
      if (!stacked) { obj[key].push((l.pm2_env.pm_uptime && status == 'online') ? timeSince(l.pm2_env.pm_uptime) : 0); }
